/*
 ...
 PluginOpticalTrem.C  -  Optical tremolo effect
...
#include <math.h>
#include "PluginOpticalTrem.h"

PluginOpticalTrem::PluginOpticalTrem ()
{
    ...
    registerPlugin(1,"Optical Trem","Circuit modelled optical trem",1);
    //{45, 140, 10, 0, 64, 64, 0},
    registerParam(0,"Depth","","","","",0,127,1,45);
    registerParam(1,"Tempo","","","","",0,127,1,140);
    ...
    registerParam(4,"Stereo","","","","",0,1,1,64);
    registerParam(5,"Panning","","","","",0,127,1,64);
    registerParam(6,"Invert","","","","",0,1,1,0);
...
int
PluginOpticalTrem::process (StereoBuffer* input)
{
...
void
PluginOpticalTrem::setpanning (int value)
{
    Ppanning = value;
...
/*
void
PluginOpticalTrem::setpreset (int npreset)
{
...
void
PluginOpticalTrem::setParam (int npar, int value)
{
...
int
PluginOpticalTrem::getParam (int npar)
{
